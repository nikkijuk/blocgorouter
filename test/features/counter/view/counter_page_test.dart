...
import 'package:blocgorouter/features/counter/cubit/counter_cubit.dart';
  ...
  group(
    ...
    () {
      testWidgets('renders CounterPage via Router as home screen',
          (tester) async {
        /*
        final event = LogIn(AuthenticatedUser(id: "123"));

        await tester.pumpAuthenticatedRealRouterApp(
            testRouter(),
